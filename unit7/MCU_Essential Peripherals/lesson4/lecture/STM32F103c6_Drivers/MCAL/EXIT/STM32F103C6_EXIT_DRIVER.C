...
void Update_EXTI(EXTI_PinConfig_t *EXTI_Config) {
	...
	uint8_t AFIO_EXTICR_Position = (EXTI_Config->EXTI_PIN.EXTI_InputLineNumber
			% 4) * 4;

	// Clear the four bit
	AFIO->EXTICR[AFIO_EXTICR_index] &= ~(0xf << AFIO_EXTICR_Position);
	AFIO->EXTICR[AFIO_EXTICR_index] |=
			(AFIO_GPIO_EXTI_Mappint(EXTI_Config->EXTI_PIN.GPIO_Port) & 0xf)
	...
	GP_IRQ_CallBack[EXTI_Config->EXTI_PIN.EXTI_InputLineNumber] =
